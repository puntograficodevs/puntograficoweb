...
public class OpcionesLonaPublicitariaService {
    ...
    public OpcionesLonaPublicitariaService(TipoLonaPublicitariaRepository tipoLonaPublicitariaRepository, MedidaLonaPublicitariaRepository medidaLonaPublicitariaRepository) {
        this.tipoLonaPublicitariaRepository = tipoLonaPublicitariaRepository;
        this.medidaLonaPublicitariaRepository = medidaLonaPublicitariaRepository;
    }
