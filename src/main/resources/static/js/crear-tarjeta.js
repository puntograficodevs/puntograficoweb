document.addEventListener("DOMContentLoaded", () => {
  ...
  const tipoPapelRadios = document.querySelectorAll("input[name='tipoPapelTarjeta.id']");
  const tipoColorRadios = document.querySelectorAll("input[name='tipoColorTarjeta.id']");
  const tipoFazRadios = document.querySelectorAll("input[name='tipoFazTarjeta.id']");
  const tipoLaminadoRadios = document.querySelectorAll("input[name='tipoLaminadoTarjeta.id']");
  const medidaRadios = document.querySelectorAll("input[name='medidaTarjeta.id']");
  ...
  const cantidadRadios = document.querySelectorAll("input[name='cantidadTarjeta.id']");
  ...
  const adicionalDisenioCheckbox = document.getElementById("tarjeta-con-adicional-disenio");
  ...
  [tipoPapelRadios, tipoColorRadios, tipoFazRadios, tipoLaminadoRadios, medidaRadios, cantidadRadios].forEach(grupo => {
  ...
  function buscarPrecio() {
    ...
    const tipoLaminadoId = getCheckedValue(tipoLaminadoRadios);
    ...
    if (!tipoPapelId || !tipoColorId || !tipoFazId || !tipoLaminadoId || !medidaId || !cantidadId) {
    ...
    const params = new URLSearchParams({
      tipoPapelTarjetaId: tipoPapelId,
      tipoColorTarjetaId: tipoColorId,
      tipoFazTarjetaId: tipoFazId,
      tipoLaminadoTarjetaId: tipoLaminadoId,
      medidaTarjetaId: medidaId,
      cantidadTarjetaId: cantidadId
    });

    fetch(`/api/plantilla-tarjeta/precio?${params.toString()}`)
