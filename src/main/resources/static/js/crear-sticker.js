document.addEventListener("DOMContentLoaded", () => {
  ...
  const tipoTroqueladoRadios = document.querySelectorAll("input[name='tipoTroqueladoSticker.id']");
  const medidaRadios = document.querySelectorAll("input[name='medidaSticker.id']");
  ...
  const cantidadRadios = document.querySelectorAll("input[name='cantidadSticker.id']");
  ...
  const adicionalDisenioCheckbox = document.getElementById("sticker-con-adicional-disenio");
  ...
  [tipoTroqueladoRadios, cantidadRadios, medidaRadios].forEach(grupo => {
  ...
  function buscarPrecio() {
    ...
    if (!tipoTroqueladoId || !cantidadId || !medidaId) {
    ...
    const params = new URLSearchParams({
      tipoTroqueladoStickerId: tipoTroqueladoId,
      cantidadStickerId: cantidadId,
      medidaStickerId: medidaId
    });

    fetch(`/api/plantilla-sticker/precio?${params.toString()}`)
